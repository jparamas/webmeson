document.addEventListener("DOMContentLoaded", function () {
    ...
    const fechasPermitidasISO = fechasPermitidas.map(fecha => fecha); // No need to map, already in ISO format
    ...
    const horasBloqueadasPorFecha = {
       "2025-04-23": ["20:30", "20:45", "21:00", "21:15", "21:30", "21:45", "22:00", "22:15", "22:30"],
        "2025-04-26": ["20:30", "20:45", "21:00", "21:15", "21:30", "21:45", "22:00", "22:15", "22:30", "13:00", "13:15", "13:30", "13:45", "14:00", "14:15", "14:30", "14:45", "15:00", "15:15", "15:30"],
        "2025-04-18": ["13:00", "13:15", "13:30", "13:45", "14:00", "14:15", "14:30", "14:45", "15:00", "15:15", "15:30"]
    };

    // 📌 NEW: Array to store individually cancelled dates
    const cancelledDates = ["2025-05-05", "2025-06-10"]; // Add dates you want to cancel here (YYYY-MM-DD)
